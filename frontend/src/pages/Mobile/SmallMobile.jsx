...
const SmallMobile = () => {
  ...
  return (
    <Box>
      ...
      <Box>
        <Flex gap={4} mt={3} mb={3} ml={3}>
          {/* Image  */}
          <Box>
            <Image
              width={"100px"}
              src="https://rukminim1.flixcart.com/image/416/416/ko0d6kw0/mobile/6/h/y/iphone-12-mjnm3hn-a-apple-original-imag2k2v6ehvnzfd.jpeg?q=70"
            />
          </Box>
          {/* Desc  */}
          <Box>
            ...
            <Flex gap={2}>
              <Text fontWeight={500} fontSize={"15px"}>
                <strike>72,999</strike>
              </Text>
              <Text fontWeight={500} fontSize={"15px"}>
                68,999
              </Text>
              <Text fontWeight={500} color={"green"} fontSize={"15px"}>
                22% off
              </Text>
            </Flex>
            {/* delivery */}
